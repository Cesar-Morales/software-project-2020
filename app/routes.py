...
# Rutas de Centros
app.add_url_rule("/config/centers/<int:page>","config_center_index",config.center_index)
...
app.add_url_rule("/centros_buscar/<int:page>", "center_search", center.search, methods=["GET"])
